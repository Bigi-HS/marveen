#!/bin/bash
# Watchdog for agent-kerrigan (tabletop/wargame agent, per-agent Telegram channel).
#
...
SESSION=agent-kerrigan
AGENT_DIR=/home/domin/marveen/agents/kerrigan
CFG="$AGENT_DIR/.claude-config"
STATE="$AGENT_DIR/.claude/channels/telegram"
ACONF="$AGENT_DIR/agent-config.json"
LOG=/home/domin/marveen/store/kerrigan-watchdog.log
COOLDOWN=60
MAX_PER_HOUR=8
...
log "kerrigan-watchdog started (pid $$)"
